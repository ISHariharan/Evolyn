...
const SuccessToastMessage = ({duration= 3000, onClose}) => {
  ...
  return (
    <div className={`ToastWrapper ${visible ? "show" : "hide"}`}>
        <div className="SuccessToastMessage-card">
            <svg
                className="SuccessToastMessage-wave"
            ...
            <div className="SuccessToastMessage-icon-container">
                <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                strokeWidth={0}
                fill="currentColor"
                stroke="currentColor"
                className="SuccessToastMessage-icon"
                >
            ...
            <svg
                ...
                fill="none"
                stroke="currentColor"
                className="SuccessToastMessage-cross-icon"
            >
                <path
                fill="currentColor"
