...
const ErrorToastMessage = ({ duration = 3000, ToastMessageHeader, ToastMessageBody  }) => {
  ...
  return (
    <div className={`ToastWrapper ${visible ? "show" : "hide"}`}>
      <div className="ErrorToastMessage-card">
        <svg
          className="ErrorToastMessage-wave"
        ...
        <div className="ErrorToastMessage-icon-container">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            strokeWidth={0}
            fill="currentColor"
            stroke="currentColor"
            className="ErrorToastMessage-icon"
          >
        ...
        <svg
          ...
          fill="none"
          stroke="currentColor"
          className="ErrorToastMessage-cross-icon"
        >
          <path
            fill="currentColor"
